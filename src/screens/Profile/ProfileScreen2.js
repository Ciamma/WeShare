...
<SafeAreaView style={styles.root}>
  <ScrollView style={{paddingLeft:15, paddingRight:10}} showVerticalScrollIndicator={false}>


    <Formik
      initialValues={{fullName:'', dateOfBirth:'', emailAddress:'', phoneNumber:'', facebook: '', instagram:'', linkedin:'', twitter:'', cardTitle:'', bio:''}}
      onSubmit={(values) => {
        
        console.log(values);
        {() => {navigation.navigate('Profile1',{values})}};
